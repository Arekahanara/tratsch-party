          ...
          <div class="brand d-flex justify-content-center align-items-center">
            <span v-if="channel">
              <b-dropdown id="ddown1" :text="channel.name" class="m-md-2">
                ...
                <b-dropdown-item v-for="item in channels" :key="item._id" :to="{ name: 'channel', params: { channelSlug: item.slug } }" :active="false">{{item.name}}</b-dropdown-item>
            ...
            <span v-else>
              <b-dropdown id="ddown1" text="Tratsch.Party" class="m-md-2" v-if="channels">
                <b-dropdown-header>Channels</b-dropdown-header>
                <b-dropdown-item v-for="item in channels" :key="item._id" :to="{ name: 'channel', params: { channelSlug: item.slug }}">{{item.name}}</b-dropdown-item>
              </b-dropdown>
            </span>
          </div>
        </div>
